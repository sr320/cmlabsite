...
- Writing accountability session 1 of 2 with Taylor this morning. I used this early time to catch up on emails and prep for my quiz section wekly round-up emails to set them up for the following week.
...
- Reviewed the SOD protocol from the manufacturer as well as the modified protocol we already had. I wrote up a consolidated version to support what we need in preparation for Tuesday.
